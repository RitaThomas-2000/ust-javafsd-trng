...
public class Json_Read {
	public static void main(String args[]) {
		...
		try {
			FileReader fr = new FileReader("C:\\Users\\ustjavafsdb220\\Downloads\\EmployeeData.json");
			JSONArray ar = (JSONArray)p.parse(fr);
			
			
			FileOutputStream ofile =new FileOutputStream("C:\\\\Users\\\\ustjavafsdb220\\\\Downloads\\\\Employee.xlsx");
			HSSFWorkbook w = new HSSFWorkbook();
			HSSFSheet s1 = w.createSheet("Sheet1");
